...
module.exports = async (req, res) => {
  try {
    ...
    if (ticket.dataValues.row || ticket.dataValues.division === "Tribunas Generales") {
      ...
      return res.redirect(302, `http://localhost:3000/success/${ticket.dataValues.id}`);
      ...
      return res.redirect(302, `http://localhost:3000/general/ticket/success/${ticket.dataValues.id}`);
    }
